...
/**
 * RegisterForm — güvenlik sorulu kayıt + otomatik login.
 * Register başarılı olunca backend'den gelen user+token ile hemen
 * login ediyoruz (bir "welcome" akışı değil, doğrudan anasayfaya).
 */
