...
/**
 * ContactPage — iletişim formu. Client component (form state).
 *
 * Pattern'ler:
 *  - useState ile kontrollü form (tek obje)
 *  - Elle client-side validation (required, email regex, min length)
 *  - Submit sırasında button disabled, bitince toast
 */
    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div className="mt-10 grid gap-8 md:grid-cols-3">
        <div className="space-y-4 animate-slide-up">
          <InfoBlock icon={Mail}  title="E-posta" value="hello@devilyxrd.dev" href="mailto:hello@devilyxrd.dev" />
          <InfoBlock icon={Phone} title="Telefon" value="+90 555 000 00 00" href="tel:+905550000000" />
          <InfoBlock icon={MapPin} title="Adres" value="İstanbul, Türkiye" />
        </div>
        ...
        <Card className="md:col-span-2 animate-slide-up" style={{ animationDelay: '80ms' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="mb-1.5 block text-sm font-medium text-zinc-300">Mesaj</label>
              <textarea
                value={form.message}
