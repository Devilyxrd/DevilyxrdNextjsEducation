...
/**
 * ProductsPage — ürün listesi + filtre + arama.
 *
 * Next.js notu: Bu component `app/products/page.tsx` içinden render edilir,
 * ama kendisi client component ('use client'). Filtreler URL'e bağlı değil;
 * isteğe bağlı olarak `useSearchParams` ile URL sync edilebilir.
 *
 * Pattern'ler:
 *  - useEffect + cancelled flag (race condition koruma)
 *  - useDebounce (arama)
 *  - useMemo (filtrelenmiş liste)
 *  - 4 rendering durumu: loading / error / empty / data
 */
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {loading ? (
        ...
        <EmptyState icon={PackageX} title="Bir şeyler ters gitti" description={error} />
      ) : filtered.length === 0 ? (
        <EmptyState
          icon={PackageX}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? 'bg-brand-500 text-zinc-950 shadow-lg shadow-brand-500/30'
