 ...
 * Status'e göre Badge renkleri değişir.
 */

const statusLabels: Record<
  OrderStatus,
  { label: string; variant: 'warning' | 'info' | 'brand' | 'success' }
> = {
      ...
      <div className="space-y-2">
        {order.items.map((it) => (
          <div key={it.productId} className="flex items-center gap-3 text-sm">
            <div className="relative h-10 w-10 overflow-hidden rounded-md bg-zinc-800 shrink-0">
