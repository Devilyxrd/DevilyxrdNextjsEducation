...
/**
 * CartPage — sepet.
 * Tamamen store'a bağlı. Her selector ayrı ayrı karşılaştırılır; gereksiz
 * re-render olmaz. Derived state (total, itemCount) store'da fonksiyon.
 */
        ...
        <div className="grid gap-6 md:grid-cols-[1fr_320px]">
          <div className="space-y-3">
            ...
            <div className="mt-4 rounded-lg border border-zinc-800 bg-zinc-900/40 p-4 animate-fade-in">
              {freeShipping ? (
                <p className="text-sm text-emerald-400">🎉 Ücretsiz kargo kazandın!</p>
              ) : (
                <>
